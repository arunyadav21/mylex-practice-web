...
const Otp = () => {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      const credential = PhoneAuthProvider.credential(storedResult.verificationId, otpCode);
      ...
      navigate(userSnap.exists() ? '/home' : '/register');
        ...
        <div className="p-8">
          ...
          <button
            ...
            className={`w-full py-3 px-4 rounded-lg text-white font-medium transition-all ${
              ...
              otp.join('').length !== 6 ? 'bg-gray-400' : 'bg-blue-600 hover:bg-blue-700'
            }`}
          >
            {isLoading ? (
